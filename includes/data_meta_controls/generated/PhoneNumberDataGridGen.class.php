<?php
     ...
     * listing a collection of PhoneNumber objects.  It includes
     ...
     * 
     */
    class PhoneNumberDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this PhoneNumber datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the PhoneNumber object, or it can be any QQNode extending from QQN::PhoneNumber().
         * 
         ...
         * sorting using two fields from the PhoneNumber object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from PhoneNumber
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = PhoneNumber::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from PhoneNumber, given the clauses above
            $this->DataSource = PhoneNumber::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a PhoneNumber-based QQNode.
         * It will also verify that it is a proper PhoneNumber-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'phone_number') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "phone_number".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::PhoneNumber()->Id;
                case 'Number': return QQN::PhoneNumber()->Number;
                case 'PersonId': return QQN::PhoneNumber()->PersonId;
                case 'Person': return QQN::PhoneNumber()->Person;
                case 'IsPrimary': return QQN::PhoneNumber()->IsPrimary;
                default: throw new QCallerException('Simple Property not found in PhoneNumberDataGrid content: ' . $mixContent);
