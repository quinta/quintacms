<?php
     ...
     * listing a collection of PaypalTransaction objects.  It includes
     ...
     * 
     */
    class PaypalTransactionDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this PaypalTransaction datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the PaypalTransaction object, or it can be any QQNode extending from QQN::PaypalTransaction().
         * 
         ...
         * sorting using two fields from the PaypalTransaction object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from PaypalTransaction
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = PaypalTransaction::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from PaypalTransaction, given the clauses above
            $this->DataSource = PaypalTransaction::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a PaypalTransaction-based QQNode.
         * It will also verify that it is a proper PaypalTransaction-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'paypal_transaction') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "paypal_transaction".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::PaypalTransaction()->Id;
                case 'OrderId': return QQN::PaypalTransaction()->OrderId;
                case 'Order': return QQN::PaypalTransaction()->Order;
                case 'CorrelationId': return QQN::PaypalTransaction()->CorrelationId;
                case 'TransactionId': return QQN::PaypalTransaction()->TransactionId;
                case 'PpToken': return QQN::PaypalTransaction()->PpToken;
                case 'PayerId': return QQN::PaypalTransaction()->PayerId;
                case 'PayerStatus': return QQN::PaypalTransaction()->PayerStatus;
                case 'PaymentStatus': return QQN::PaypalTransaction()->PaymentStatus;
                case 'AckReturned': return QQN::PaypalTransaction()->AckReturned;
                case 'ApiAction': return QQN::PaypalTransaction()->ApiAction;
                case 'TimeStamp': return QQN::PaypalTransaction()->TimeStamp;
                case 'ApiVersion': return QQN::PaypalTransaction()->ApiVersion;
                case 'Messages': return QQN::PaypalTransaction()->Messages;
                case 'Amount': return QQN::PaypalTransaction()->Amount;
                case 'PpFee': return QQN::PaypalTransaction()->PpFee;
                case 'PaymentMethodId': return QQN::PaypalTransaction()->PaymentMethodId;
                default: throw new QCallerException('Simple Property not found in PaypalTransactionDataGrid content: ' . $mixContent);
