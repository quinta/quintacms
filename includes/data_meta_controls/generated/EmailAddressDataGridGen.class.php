<?php
     ...
     * listing a collection of EmailAddress objects.  It includes
     ...
     * 
     */
    class EmailAddressDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this EmailAddress datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the EmailAddress object, or it can be any QQNode extending from QQN::EmailAddress().
         * 
         ...
         * sorting using two fields from the EmailAddress object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from EmailAddress
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = EmailAddress::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from EmailAddress, given the clauses above
            $this->DataSource = EmailAddress::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a EmailAddress-based QQNode.
         * It will also verify that it is a proper EmailAddress-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'email_address') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "email_address".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::EmailAddress()->Id;
                case 'Url': return QQN::EmailAddress()->Url;
                case 'PersonId': return QQN::EmailAddress()->PersonId;
                case 'Person': return QQN::EmailAddress()->Person;
                case 'IsPrimary': return QQN::EmailAddress()->IsPrimary;
                default: throw new QCallerException('Simple Property not found in EmailAddressDataGrid content: ' . $mixContent);
