<?php
     ...
     * listing a collection of ProductImage objects.  It includes
     ...
     * 
     */
    class ProductImageDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this ProductImage datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the ProductImage object, or it can be any QQNode extending from QQN::ProductImage().
         * 
         ...
         * sorting using two fields from the ProductImage object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from ProductImage
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = ProductImage::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from ProductImage, given the clauses above
            $this->DataSource = ProductImage::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a ProductImage-based QQNode.
         * It will also verify that it is a proper ProductImage-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'product_image') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "product_image".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::ProductImage()->Id;
                case 'ProductId': return QQN::ProductImage()->ProductId;
                case 'Product': return QQN::ProductImage()->Product;
                case 'Title': return QQN::ProductImage()->Title;
                case 'AltTag': return QQN::ProductImage()->AltTag;
                case 'Description': return QQN::ProductImage()->Description;
                case 'Uri': return QQN::ProductImage()->Uri;
                case 'XSize': return QQN::ProductImage()->XSize;
                case 'YSize': return QQN::ProductImage()->YSize;
                case 'SizeType': return QQN::ProductImage()->SizeType;
                default: throw new QCallerException('Simple Property not found in ProductImageDataGrid content: ' . $mixContent);
