<?php
     ...
     * listing a collection of Order objects.  It includes
     ...
     * 
     */
    class OrderDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this Order datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the Order object, or it can be any QQNode extending from QQN::Order().
         * 
         ...
         * sorting using two fields from the Order object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from Order
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = Order::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from Order, given the clauses above
            $this->DataSource = Order::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a Order-based QQNode.
         * It will also verify that it is a proper Order-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'order') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "order".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::Order()->Id;
                case 'AccountId': return QQN::Order()->AccountId;
                case 'Account': return QQN::Order()->Account;
                case 'CreationDate': return QQN::Order()->CreationDate;
                case 'LastModification': return QQN::Order()->LastModification;
                case 'CompletionDate': return QQN::Order()->CompletionDate;
                case 'ProductTotalCost': return QQN::Order()->ProductTotalCost;
                case 'ShippingCost': return QQN::Order()->ShippingCost;
                case 'ShippingCharged': return QQN::Order()->ShippingCharged;
                case 'HandlingCost': return QQN::Order()->HandlingCost;
                case 'HandlingCharged': return QQN::Order()->HandlingCharged;
                case 'Tax': return QQN::Order()->Tax;
                case 'ProductTotalCharged': return QQN::Order()->ProductTotalCharged;
                case 'Notes': return QQN::Order()->Notes;
                case 'ShippingMethodId': return QQN::Order()->ShippingMethodId;
                case 'ShippingMethod': return QQN::Order()->ShippingMethod;
                case 'PaymentMethodId': return QQN::Order()->PaymentMethodId;
                case 'PaymentMethod': return QQN::Order()->PaymentMethod;
                case 'StatusId': return QQN::Order()->StatusId;
                case 'TypeId': return QQN::Order()->TypeId;
                default: throw new QCallerException('Simple Property not found in OrderDataGrid content: ' . $mixContent);
