<?php
     ...
     * listing a collection of Product objects.  It includes
     ...
     * 
     */
    class ProductDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this Product datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the Product object, or it can be any QQNode extending from QQN::Product().
         * 
         ...
         * sorting using two fields from the Product object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from Product
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = Product::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from Product, given the clauses above
            $this->DataSource = Product::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a Product-based QQNode.
         * It will also verify that it is a proper Product-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'product') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "product".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::Product()->Id;
                case 'ManufacturerId': return QQN::Product()->ManufacturerId;
                case 'Manufacturer': return QQN::Product()->Manufacturer;
                case 'SupplierId': return QQN::Product()->SupplierId;
                case 'Supplier': return QQN::Product()->Supplier;
                case 'CreationDate': return QQN::Product()->CreationDate;
                case 'Name': return QQN::Product()->Name;
                case 'Model': return QQN::Product()->Model;
                case 'ShortDescription': return QQN::Product()->ShortDescription;
                case 'LongDescription': return QQN::Product()->LongDescription;
                case 'Msrp': return QQN::Product()->Msrp;
                case 'WholesalePrice': return QQN::Product()->WholesalePrice;
                case 'RetailPrice': return QQN::Product()->RetailPrice;
                case 'Cost': return QQN::Product()->Cost;
                case 'Weight': return QQN::Product()->Weight;
                case 'Height': return QQN::Product()->Height;
                case 'Width': return QQN::Product()->Width;
                case 'Depth': return QQN::Product()->Depth;
                case 'IsVirtual': return QQN::Product()->IsVirtual;
                case 'TypeId': return QQN::Product()->TypeId;
                case 'StatusId': return QQN::Product()->StatusId;
                case 'ViewCount': return QQN::Product()->ViewCount;
                default: throw new QCallerException('Simple Property not found in ProductDataGrid content: ' . $mixContent);
