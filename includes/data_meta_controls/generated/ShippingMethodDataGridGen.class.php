<?php
     ...
     * listing a collection of ShippingMethod objects.  It includes
     ...
     * 
     */
    class ShippingMethodDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this ShippingMethod datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the ShippingMethod object, or it can be any QQNode extending from QQN::ShippingMethod().
         * 
         ...
         * sorting using two fields from the ShippingMethod object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from ShippingMethod
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = ShippingMethod::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from ShippingMethod, given the clauses above
            $this->DataSource = ShippingMethod::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a ShippingMethod-based QQNode.
         * It will also verify that it is a proper ShippingMethod-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'shipping_method') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "shipping_method".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::ShippingMethod()->Id;
                case 'Title': return QQN::ShippingMethod()->Title;
                case 'Carrier': return QQN::ShippingMethod()->Carrier;
                case 'ServiceType': return QQN::ShippingMethod()->ServiceType;
                case 'ClassName': return QQN::ShippingMethod()->ClassName;
                case 'TransitTime': return QQN::ShippingMethod()->TransitTime;
                case 'Description': return QQN::ShippingMethod()->Description;
                case 'ImageFilename': return QQN::ShippingMethod()->ImageFilename;
                case 'Active': return QQN::ShippingMethod()->Active;
                case 'IsInternational': return QQN::ShippingMethod()->IsInternational;
                case 'TestMode': return QQN::ShippingMethod()->TestMode;
                case 'SortOrder': return QQN::ShippingMethod()->SortOrder;
                default: throw new QCallerException('Simple Property not found in ShippingMethodDataGrid content: ' . $mixContent);
