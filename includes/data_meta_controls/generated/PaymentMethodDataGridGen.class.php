<?php
     ...
     * listing a collection of PaymentMethod objects.  It includes
     ...
     * 
     */
    class PaymentMethodDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this PaymentMethod datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the PaymentMethod object, or it can be any QQNode extending from QQN::PaymentMethod().
         * 
         ...
         * sorting using two fields from the PaymentMethod object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from PaymentMethod
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = PaymentMethod::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from PaymentMethod, given the clauses above
            $this->DataSource = PaymentMethod::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a PaymentMethod-based QQNode.
         * It will also verify that it is a proper PaymentMethod-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'payment_method') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "payment_method".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::PaymentMethod()->Id;
                case 'Title': return QQN::PaymentMethod()->Title;
                case 'ServiceProvider': return QQN::PaymentMethod()->ServiceProvider;
                case 'ServiceType': return QQN::PaymentMethod()->ServiceType;
                case 'ActionClassName': return QQN::PaymentMethod()->ActionClassName;
                case 'Description': return QQN::PaymentMethod()->Description;
                case 'ImageUri': return QQN::PaymentMethod()->ImageUri;
                case 'Active': return QQN::PaymentMethod()->Active;
                case 'RequiresCcNumber': return QQN::PaymentMethod()->RequiresCcNumber;
                case 'SaveCcNumber': return QQN::PaymentMethod()->SaveCcNumber;
                case 'TestMode': return QQN::PaymentMethod()->TestMode;
                case 'SortOrder': return QQN::PaymentMethod()->SortOrder;
                case 'PaymentTypeId': return QQN::PaymentMethod()->PaymentTypeId;
                default: throw new QCallerException('Simple Property not found in PaymentMethodDataGrid content: ' . $mixContent);
