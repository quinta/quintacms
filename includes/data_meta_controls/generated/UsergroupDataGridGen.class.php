<?php
     ...
     * listing a collection of Usergroup objects.  It includes
     ...
     * 
     */
    class UsergroupDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this Usergroup datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the Usergroup object, or it can be any QQNode extending from QQN::Usergroup().
         * 
         ...
         * sorting using two fields from the Usergroup object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from Usergroup
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = Usergroup::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from Usergroup, given the clauses above
            $this->DataSource = Usergroup::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a Usergroup-based QQNode.
         * It will also verify that it is a proper Usergroup-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'usergroup') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "usergroup".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::Usergroup()->Id;
                case 'Name': return QQN::Usergroup()->Name;
                default: throw new QCallerException('Simple Property not found in UsergroupDataGrid content: ' . $mixContent);
