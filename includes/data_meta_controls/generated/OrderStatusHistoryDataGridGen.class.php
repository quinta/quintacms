<?php
     ...
     * listing a collection of OrderStatusHistory objects.  It includes
     ...
     * 
     */
    class OrderStatusHistoryDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this OrderStatusHistory datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the OrderStatusHistory object, or it can be any QQNode extending from QQN::OrderStatusHistory().
         * 
         ...
         * sorting using two fields from the OrderStatusHistory object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from OrderStatusHistory
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = OrderStatusHistory::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from OrderStatusHistory, given the clauses above
            $this->DataSource = OrderStatusHistory::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a OrderStatusHistory-based QQNode.
         * It will also verify that it is a proper OrderStatusHistory-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'order_status_history') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "order_status_history".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::OrderStatusHistory()->Id;
                case 'OrderId': return QQN::OrderStatusHistory()->OrderId;
                case 'Order': return QQN::OrderStatusHistory()->Order;
                case 'Date': return QQN::OrderStatusHistory()->Date;
                case 'Notes': return QQN::OrderStatusHistory()->Notes;
                case 'StatusId': return QQN::OrderStatusHistory()->StatusId;
                default: throw new QCallerException('Simple Property not found in OrderStatusHistoryDataGrid content: ' . $mixContent);
