<?php
     ...
     * listing a collection of ShoppingCart objects.  It includes
     ...
     * 
     */
    class ShoppingCartDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this ShoppingCart datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the ShoppingCart object, or it can be any QQNode extending from QQN::ShoppingCart().
         * 
         ...
         * sorting using two fields from the ShoppingCart object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from ShoppingCart
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = ShoppingCart::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from ShoppingCart, given the clauses above
            $this->DataSource = ShoppingCart::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a ShoppingCart-based QQNode.
         * It will also verify that it is a proper ShoppingCart-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'shopping_cart') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "shopping_cart".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::ShoppingCart()->Id;
                case 'CreationDate': return QQN::ShoppingCart()->CreationDate;
                case 'LastModification': return QQN::ShoppingCart()->LastModification;
                case 'AccountId': return QQN::ShoppingCart()->AccountId;
                case 'Account': return QQN::ShoppingCart()->Account;
                default: throw new QCallerException('Simple Property not found in ShoppingCartDataGrid content: ' . $mixContent);
