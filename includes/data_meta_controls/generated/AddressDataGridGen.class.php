    ...
    class AddressDataGridGen extends QDataGrid {
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                case 'Title': return QQN::Address()->Title;
                case 'PersonId': return QQN::Address()->PersonId;
                case 'Person': return QQN::Address()->Person;
                case 'Street1': return QQN::Address()->Street1;
                case 'Street2': return QQN::Address()->Street2;
                case 'Suburb': return QQN::Address()->Suburb;
                case 'City': return QQN::Address()->City;
                case 'County': return QQN::Address()->County;
                case 'ZoneId': return QQN::Address()->ZoneId;
                case 'CountryId': return QQN::Address()->CountryId;
                case 'PostalCode': return QQN::Address()->PostalCode;
                case 'IsCurrent': return QQN::Address()->IsCurrent;
                case 'TypeId': return QQN::Address()->TypeId;
                case 'CreationDate': return QQN::Address()->CreationDate;
                case 'LastModification': return QQN::Address()->LastModification;
