<?php
     ...
     * listing a collection of ContentItem objects.  It includes
     ...
     * 
     */
    class ContentItemDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this ContentItem datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the ContentItem object, or it can be any QQNode extending from QQN::ContentItem().
         * 
         ...
         * sorting using two fields from the ContentItem object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from ContentItem
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = ContentItem::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from ContentItem, given the clauses above
            $this->DataSource = ContentItem::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a ContentItem-based QQNode.
         * It will also verify that it is a proper ContentItem-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'content_item') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "content_item".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::ContentItem()->Id;
                case 'Name': return QQN::ContentItem()->Name;
                case 'Cssclass': return QQN::ContentItem()->Cssclass;
                case 'Title': return QQN::ContentItem()->Title;
                case 'Description': return QQN::ContentItem()->Description;
                case 'Text': return QQN::ContentItem()->Text;
                case 'SortOrder': return QQN::ContentItem()->SortOrder;
                case 'ShowTitle': return QQN::ContentItem()->ShowTitle;
                case 'ShowDescription': return QQN::ContentItem()->ShowDescription;
                case 'ShowCreator': return QQN::ContentItem()->ShowCreator;
                case 'ShowCreationDate': return QQN::ContentItem()->ShowCreationDate;
                case 'ShowLastModification': return QQN::ContentItem()->ShowLastModification;
                case 'CreatorId': return QQN::ContentItem()->CreatorId;
                case 'Creator': return QQN::ContentItem()->Creator;
                case 'CopyrightNotice': return QQN::ContentItem()->CopyrightNotice;
                case 'CreationDate': return QQN::ContentItem()->CreationDate;
                case 'LastModification': return QQN::ContentItem()->LastModification;
                case 'TypeId': return QQN::ContentItem()->TypeId;
                case 'StatusId': return QQN::ContentItem()->StatusId;
                default: throw new QCallerException('Simple Property not found in ContentItemDataGrid content: ' . $mixContent);
