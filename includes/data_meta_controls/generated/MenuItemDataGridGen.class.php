<?php
     ...
     * listing a collection of MenuItem objects.  It includes
     ...
     * 
     */
    class MenuItemDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this MenuItem datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the MenuItem object, or it can be any QQNode extending from QQN::MenuItem().
         * 
         ...
         * sorting using two fields from the MenuItem object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from MenuItem
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = MenuItem::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from MenuItem, given the clauses above
            $this->DataSource = MenuItem::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a MenuItem-based QQNode.
         * It will also verify that it is a proper MenuItem-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'menu_item') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "menu_item".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::MenuItem()->Id;
                case 'Name': return QQN::MenuItem()->Name;
                case 'CssClass': return QQN::MenuItem()->CssClass;
                case 'Label': return QQN::MenuItem()->Label;
                case 'Uri': return QQN::MenuItem()->Uri;
                case 'IsLocal': return QQN::MenuItem()->IsLocal;
                case 'IsSsl': return QQN::MenuItem()->IsSsl;
                case 'SortOrder': return QQN::MenuItem()->SortOrder;
                case 'StatusId': return QQN::MenuItem()->StatusId;
                case 'TypeId': return QQN::MenuItem()->TypeId;
                case 'PageId': return QQN::MenuItem()->PageId;
                case 'Page': return QQN::MenuItem()->Page;
                default: throw new QCallerException('Simple Property not found in MenuItemDataGrid content: ' . $mixContent);
