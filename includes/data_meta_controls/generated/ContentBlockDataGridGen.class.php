<?php
     ...
     * listing a collection of ContentBlock objects.  It includes
     ...
     * 
     */
    class ContentBlockDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this ContentBlock datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the ContentBlock object, or it can be any QQNode extending from QQN::ContentBlock().
         * 
         ...
         * sorting using two fields from the ContentBlock object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from ContentBlock
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = ContentBlock::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from ContentBlock, given the clauses above
            $this->DataSource = ContentBlock::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a ContentBlock-based QQNode.
         * It will also verify that it is a proper ContentBlock-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'content_block') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "content_block".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::ContentBlock()->Id;
                case 'Name': return QQN::ContentBlock()->Name;
                case 'Cssclass': return QQN::ContentBlock()->Cssclass;
                case 'Title': return QQN::ContentBlock()->Title;
                case 'Description': return QQN::ContentBlock()->Description;
                case 'ShowTitle': return QQN::ContentBlock()->ShowTitle;
                case 'ShowDescription': return QQN::ContentBlock()->ShowDescription;
                case 'Collapsable': return QQN::ContentBlock()->Collapsable;
                case 'SortOrder': return QQN::ContentBlock()->SortOrder;
                case 'ParentContentBlockId': return QQN::ContentBlock()->ParentContentBlockId;
                case 'LocationId': return QQN::ContentBlock()->LocationId;
                default: throw new QCallerException('Simple Property not found in ContentBlockDataGrid content: ' . $mixContent);
