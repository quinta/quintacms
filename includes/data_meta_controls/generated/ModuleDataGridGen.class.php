<?php
     ...
     * listing a collection of Module objects.  It includes
     ...
     * 
     */
    class ModuleDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this Module datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the Module object, or it can be any QQNode extending from QQN::Module().
         * 
         ...
         * sorting using two fields from the Module object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from Module
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = Module::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from Module, given the clauses above
            $this->DataSource = Module::LoadAll($objClauses);
        }
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                case 'Id': return QQN::Module()->Id;
                case 'Name': return QQN::Module()->Name;
                case 'Cssclass': return QQN::Module()->Cssclass;
                case 'Title': return QQN::Module()->Title;
                case 'Description': return QQN::Module()->Description;
                case 'ClassName': return QQN::Module()->ClassName;
                case 'ShowTitle': return QQN::Module()->ShowTitle;
                case 'ShowDescription': return QQN::Module()->ShowDescription;
                case 'ContentBlockId': return QQN::Module()->ContentBlockId;
                case 'ContentBlock': return QQN::Module()->ContentBlock;
                case 'ParentModuleId': return QQN::Module()->ParentModuleId;
                case 'ParentModule': return QQN::Module()->ParentModule;
                default: throw new QCallerException('Simple Property not found in ModuleDataGrid content: ' . $mixContent);
