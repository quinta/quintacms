<?php
     ...
     * listing a collection of AuthorizeNetTransaction objects.  It includes
     ...
     * 
     */
    class AuthorizeNetTransactionDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this AuthorizeNetTransaction datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the AuthorizeNetTransaction object, or it can be any QQNode extending from QQN::AuthorizeNetTransaction().
         * 
         ...
         * sorting using two fields from the AuthorizeNetTransaction object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from AuthorizeNetTransaction
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = AuthorizeNetTransaction::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from AuthorizeNetTransaction, given the clauses above
            $this->DataSource = AuthorizeNetTransaction::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a AuthorizeNetTransaction-based QQNode.
         * It will also verify that it is a proper AuthorizeNetTransaction-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'authorize_net_transaction') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "authorize_net_transaction".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::AuthorizeNetTransaction()->Id;
                case 'OrderId': return QQN::AuthorizeNetTransaction()->OrderId;
                case 'Order': return QQN::AuthorizeNetTransaction()->Order;
                case 'CreationDate': return QQN::AuthorizeNetTransaction()->CreationDate;
                case 'ResponseCode': return QQN::AuthorizeNetTransaction()->ResponseCode;
                case 'ResponseSubcode': return QQN::AuthorizeNetTransaction()->ResponseSubcode;
                case 'ResponseReasonCode': return QQN::AuthorizeNetTransaction()->ResponseReasonCode;
                case 'ResponseReasonText': return QQN::AuthorizeNetTransaction()->ResponseReasonText;
                case 'AuthorizationCode': return QQN::AuthorizeNetTransaction()->AuthorizationCode;
                case 'TransactionId': return QQN::AuthorizeNetTransaction()->TransactionId;
                case 'TransactionType': return QQN::AuthorizeNetTransaction()->TransactionType;
                case 'Amount': return QQN::AuthorizeNetTransaction()->Amount;
                case 'AvsResponseCode': return QQN::AuthorizeNetTransaction()->AvsResponseCode;
                case 'CcvResponseCode': return QQN::AuthorizeNetTransaction()->CcvResponseCode;
                case 'CavResponseCode': return QQN::AuthorizeNetTransaction()->CavResponseCode;
                default: throw new QCallerException('Simple Property not found in AuthorizeNetTransactionDataGrid content: ' . $mixContent);
