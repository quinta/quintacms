<?php
     ...
     * listing a collection of HtmlMetaTag objects.  It includes
     ...
     * 
     */
    class HtmlMetaTagDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this HtmlMetaTag datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the HtmlMetaTag object, or it can be any QQNode extending from QQN::HtmlMetaTag().
         * 
         ...
         * sorting using two fields from the HtmlMetaTag object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from HtmlMetaTag
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = HtmlMetaTag::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from HtmlMetaTag, given the clauses above
            $this->DataSource = HtmlMetaTag::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a HtmlMetaTag-based QQNode.
         * It will also verify that it is a proper HtmlMetaTag-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'html_meta_tag') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "html_meta_tag".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::HtmlMetaTag()->Id;
                case 'Name': return QQN::HtmlMetaTag()->Name;
                case 'Content': return QQN::HtmlMetaTag()->Content;
                case 'Type': return QQN::HtmlMetaTag()->Type;
                default: throw new QCallerException('Simple Property not found in HtmlMetaTagDataGrid content: ' . $mixContent);
