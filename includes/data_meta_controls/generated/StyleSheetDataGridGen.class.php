<?php
     ...
     * listing a collection of StyleSheet objects.  It includes
     ...
     * 
     */
    class StyleSheetDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this StyleSheet datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the StyleSheet object, or it can be any QQNode extending from QQN::StyleSheet().
         * 
         ...
         * sorting using two fields from the StyleSheet object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from StyleSheet
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = StyleSheet::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from StyleSheet, given the clauses above
            $this->DataSource = StyleSheet::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a StyleSheet-based QQNode.
         * It will also verify that it is a proper StyleSheet-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'style_sheet') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "style_sheet".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::StyleSheet()->Id;
                case 'Name': return QQN::StyleSheet()->Name;
                case 'Description': return QQN::StyleSheet()->Description;
                case 'Filename': return QQN::StyleSheet()->Filename;
                case 'Type': return QQN::StyleSheet()->Type;
                default: throw new QCallerException('Simple Property not found in StyleSheetDataGrid content: ' . $mixContent);
