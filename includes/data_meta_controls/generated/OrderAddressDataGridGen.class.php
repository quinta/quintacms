<?php
     ...
     * listing a collection of OrderAddress objects.  It includes
     ...
     * 
     */
    class OrderAddressDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this OrderAddress datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the OrderAddress object, or it can be any QQNode extending from QQN::OrderAddress().
         * 
         ...
         * sorting using two fields from the OrderAddress object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from OrderAddress
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = OrderAddress::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from OrderAddress, given the clauses above
            $this->DataSource = OrderAddress::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a OrderAddress-based QQNode.
         * It will also verify that it is a proper OrderAddress-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'order_address') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "order_address".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::OrderAddress()->Id;
                case 'OrderId': return QQN::OrderAddress()->OrderId;
                case 'Order': return QQN::OrderAddress()->Order;
                case 'NamePrefix': return QQN::OrderAddress()->NamePrefix;
                case 'FirstName': return QQN::OrderAddress()->FirstName;
                case 'MiddleName': return QQN::OrderAddress()->MiddleName;
                case 'LastName': return QQN::OrderAddress()->LastName;
                case 'NameSuffix': return QQN::OrderAddress()->NameSuffix;
                case 'Company': return QQN::OrderAddress()->Company;
                case 'Street1': return QQN::OrderAddress()->Street1;
                case 'Street2': return QQN::OrderAddress()->Street2;
                case 'Suburb': return QQN::OrderAddress()->Suburb;
                case 'City': return QQN::OrderAddress()->City;
                case 'County': return QQN::OrderAddress()->County;
                case 'ZoneId': return QQN::OrderAddress()->ZoneId;
                case 'CountryId': return QQN::OrderAddress()->CountryId;
                case 'PostalCode': return QQN::OrderAddress()->PostalCode;
                case 'TypeId': return QQN::OrderAddress()->TypeId;
                case 'CreationDate': return QQN::OrderAddress()->CreationDate;
                case 'LastModification': return QQN::OrderAddress()->LastModification;
                default: throw new QCallerException('Simple Property not found in OrderAddressDataGrid content: ' . $mixContent);
