    ...
    class PersonDataGridGen extends QDataGrid {
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                case 'NamePrefix': return QQN::Person()->NamePrefix;
                ...
                case 'NameSuffix': return QQN::Person()->NameSuffix;
                case 'NickName': return QQN::Person()->NickName;
                case 'AvatarUri': return QQN::Person()->AvatarUri;
                case 'CompanyName': return QQN::Person()->CompanyName;
                case 'OwnerPersonId': return QQN::Person()->OwnerPersonId;
                case 'OwnerPerson': return QQN::Person()->OwnerPerson;
                case 'IsVirtual': return QQN::Person()->IsVirtual;
                case 'Account': return QQN::Person()->Account;
