<?php
     ...
     * listing a collection of JavaScript objects.  It includes
     ...
     * 
     */
    class JavaScriptDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this JavaScript datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the JavaScript object, or it can be any QQNode extending from QQN::JavaScript().
         * 
         ...
         * sorting using two fields from the JavaScript object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from JavaScript
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = JavaScript::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from JavaScript, given the clauses above
            $this->DataSource = JavaScript::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a JavaScript-based QQNode.
         * It will also verify that it is a proper JavaScript-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'java_script') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "java_script".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::JavaScript()->Id;
                case 'Name': return QQN::JavaScript()->Name;
                case 'Description': return QQN::JavaScript()->Description;
                case 'Filename': return QQN::JavaScript()->Filename;
                default: throw new QCallerException('Simple Property not found in JavaScriptDataGrid content: ' . $mixContent);
