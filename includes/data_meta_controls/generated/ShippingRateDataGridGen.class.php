<?php
     ...
     * listing a collection of ShippingRate objects.  It includes
     ...
     * 
     */
    class ShippingRateDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this ShippingRate datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the ShippingRate object, or it can be any QQNode extending from QQN::ShippingRate().
         * 
         ...
         * sorting using two fields from the ShippingRate object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from ShippingRate
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = ShippingRate::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from ShippingRate, given the clauses above
            $this->DataSource = ShippingRate::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a ShippingRate-based QQNode.
         * It will also verify that it is a proper ShippingRate-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'shipping_rate') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "shipping_rate".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::ShippingRate()->Id;
                case 'CreationDate': return QQN::ShippingRate()->CreationDate;
                case 'Rate': return QQN::ShippingRate()->Rate;
                case 'ZoneId': return QQN::ShippingRate()->ZoneId;
                default: throw new QCallerException('Simple Property not found in ShippingRateDataGrid content: ' . $mixContent);
