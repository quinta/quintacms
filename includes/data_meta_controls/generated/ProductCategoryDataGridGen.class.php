<?php
     ...
     * listing a collection of ProductCategory objects.  It includes
     ...
     * 
     */
    class ProductCategoryDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this ProductCategory datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the ProductCategory object, or it can be any QQNode extending from QQN::ProductCategory().
         * 
         ...
         * sorting using two fields from the ProductCategory object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from ProductCategory
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = ProductCategory::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from ProductCategory, given the clauses above
            $this->DataSource = ProductCategory::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a ProductCategory-based QQNode.
         * It will also verify that it is a proper ProductCategory-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'product_category') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "product_category".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::ProductCategory()->Id;
                case 'Name': return QQN::ProductCategory()->Name;
                case 'Title': return QQN::ProductCategory()->Title;
                case 'Description': return QQN::ProductCategory()->Description;
                case 'ImageUri': return QQN::ProductCategory()->ImageUri;
                case 'ParentProductCategoryId': return QQN::ProductCategory()->ParentProductCategoryId;
                default: throw new QCallerException('Simple Property not found in ProductCategoryDataGrid content: ' . $mixContent);
