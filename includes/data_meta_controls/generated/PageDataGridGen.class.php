<?php
     ...
     * listing a collection of Page objects.  It includes
     ...
     * 
     */
    class PageDataGridGen extends QDataGrid {
        /**
         ...
         * way of adding a column to this Page datagrid.  The description of a column's
         * content can be either a text string description of a simple field name
         * in the Page object, or it can be any QQNode extending from QQN::Page().
         * 
         ...
         * sorting using two fields from the Page object.
         *
         ...
         *
         * @param mixed $mixContent string or QQNode from Page
        ...
        public function MetaDataBinder() {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = Page::CountAll();
            }
            ...
            // Set the DataSource to be a Query result from Page, given the clauses above
            $this->DataSource = Page::LoadAll($objClauses);
        }
         ...
         *
         * Given a QQNode or a Text String, this will return a Page-based QQNode.
         * It will also verify that it is a proper Page-based QQNode, and will throw an exception otherwise.
         *
        ...
        protected function ResolveContentItem($mixContent) {
            if ($mixContent instanceof QQNode) {
                ...
                if ($mixContent->_RootTableName == 'page') {
                    ...
                    throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "page".');
            } else if (is_string($mixContent)) switch ($mixContent) {
                case 'Id': return QQN::Page()->Id;
                case 'CreationDate': return QQN::Page()->CreationDate;
                case 'LastModification': return QQN::Page()->LastModification;
                case 'Name': return QQN::Page()->Name;
                case 'Title': return QQN::Page()->Title;
                case 'Uri': return QQN::Page()->Uri;
                case 'HasHeader': return QQN::Page()->HasHeader;
                case 'HasLeftColumn': return QQN::Page()->HasLeftColumn;
                case 'HasRightColumn': return QQN::Page()->HasRightColumn;
                case 'HasFooter': return QQN::Page()->HasFooter;
                case 'TypeId': return QQN::Page()->TypeId;
                case 'DocTypeId': return QQN::Page()->DocTypeId;
                case 'StatusId': return QQN::Page()->StatusId;
                default: throw new QCallerException('Simple Property not found in PageDataGrid content: ' . $mixContent);
