<?php
	...
	class OrderEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intId = null, $strControlId = null)
		{
			...
			$this->calCompletionDate = $this->mctOrder->calCompletionDate_Create();
			...
			$this->txtHandlingCost = $this->mctOrder->txtHandlingCost_Create();
			...
			$this->lstType = $this->mctOrder->lstType_Create();
