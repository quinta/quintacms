<?php
	...
	require('QuintaDBI.php');

/**
* This class imports OsCommerce tables into Quinta.
...
//    protected $objAddress = null;
	...
	public function __construct(){
		$this->objDBI = QuintaDBI::getInstance();
		if(! $this->objDBI instanceof QuintaDBI)
	...
	*/
	protected function importAccount($aryRow){
		...
		/// Quinta login supports OsCommerce style password encryption so we do not change login info
...
*/
	...
	/**
	* This function translates an OsCommerce status to Quinta - customize to suit ..
	*/
