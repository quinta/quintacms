	...
	class Order extends OrderGen
	{
		...
		*/
		public function SendPendingNotice()
		{
			...
			$strText = Quinta::Translate('Dear') . ' ' . $objPerson->FullName . ",\n\n";
			
			$strText .= Quinta::Translate('Thank You for your order! Your payment is currently pending.') . "\n";
			$strText .= Quinta::Translate('You will receive a notification as soon as the payment has been confirmed.') . "\n\n";
			
			$strText .= $this->formatEmailOrderItemsInfo();
			$strText .= '   --------------------------------------------------' . "\n";
			$strText .= Quinta::Translate(' Thank You for placing an order with us!') . "\n";
			$strText .= Quinta::Translate(' If you have any questions please email support at ') ;
			$strText .= STORE_EMAIL_ADDRESS . "\n";
			$strText .=  STORE_NAME . ' ' . Quinta::Translate('Customer Service') . "\n";
		...
		*/
		public function SendPaidNotice()
		{
			...
			$strText .= Quinta::Translate('Thank You for your order!') . "\n\n";
			...
			$strText .= '   --------------------------------------------------' . "\n";
			$strText .= Quinta::Translate(' Thank You for placing an order with us!') . "\n";
			$strText .= Quinta::Translate(' You will recieve a shipping confirmation as soon as your order is shipped.') . "\n";
			$strText .= Quinta::Translate(' If you have any questions please email support at ') ;
			$strText .= STORE_EMAIL_ADDRESS . "\n Thank You, \n";
			$strText .=  STORE_NAME . ' ' . Quinta::Translate('Customer Service') . "\n";
		...
		*/
		public function SendShippingNotice()
		{
			...
			$strText .= Quinta::Translate('Your order has been shipped!') . "\n\n";
			$strText .= '   --------------------------------------------------' . "\n";
			$strText .= $this->formatEmailOrderShippingMethod();
			$strText .= '   --------------------------------------------------' . "\n";
			$strText .= $this->formatEmailOrderShippingAddress();
		...
		*/
		public function SendLocalPickupNotice()
		{
			...
			$strText .= Quinta::Translate(' Your order is ready!') . "\n\n";
			$strText .= Quinta::Translate(' You can pickup your order during regular business hours.') . "\n";
			$strText .= Quinta::Translate(' Our address is: ') . "\n\n";
		...
		*/
		public function SendProblemNotice()
		{
			...
			$strText .= Quinta::Translate(' We have encountered a problem processing your order!') . "\n\n";
			
			$strText .= Quinta::Translate(' Thank You for placing an order with us - we have run into a '
														 . 'problem that requires your attention.') . "\n";
			$strText .= Quinta::Translate(' Please reply to this or email support at ') ;
...
//            $aryConditions[] = QQ::Equal(QQN::Address()->PersonId, $this->Account->PersonId );            
		...
		*/
		...
		{            
			$strToReturn = Quinta::Translate(' The following is your order information') . ":\n\n";
			$strToReturn .= '   --------------------------------------------------'  . "\n";
			$strToReturn .= Quinta::Translate('Order Number') . ': ' . $this->Id  . "\n";
			$strToReturn .= Quinta::Translate('Detailed Invoice') . ': http://' . Quinta::$ServerName . __QUINTA_SUBDIRECTORY__
																					 . '/index.php/AccountHome/Order/' . $this->Id  . "\n";
			$strToReturn .= Quinta::Translate('Date Ordered') . ': ' . $this->CreationDate . "\n" ;

			$strToReturn .= '   --------------------------------------------------' . "\n";
			$strToReturn .= Quinta::Translate('Products on Order') . ":\n\n" ;
			...
			$strToReturn .= "\n" . Quinta::Translate('Subtotal') . ': ' . money_format('%n', $this->ProductTotalCharged);
			$strToReturn .= "\n" . Quinta::Translate('Shipping') . ': ' . money_format('%n', $this->ShippingCharged);
			$strToReturn .= "\n" . Quinta::Translate('Handling') . ': ' . money_format('%n', $this->HandlingCharged);
			$strToReturn .= "\n" . Quinta::Translate('Total') . ': ' . money_format('%n', ($this->HandlingCharged
		...
		*/
		protected function formatEmailOrderPaymentMethod()
		{
			...
			$strToReturn = Quinta::Translate('Payment Method') . ": \n";
		...
		*/
		protected function formatEmailOrderShippingMethod()
		{
			...
			$strToReturn = Quinta::Translate('Shipping Method') . ": \n";
			$strToReturn .= $objShippingMethod->Title . ' ' . $objShippingMethod->ServiceType . "\n";
			$strToReturn .= Quinta::Translate('Estimated Transit time: ') . $objShippingMethod->TransitTime . "\n";            
			return $strToReturn;
		}
		/**
		...
		*/
		...
		{
			$strToReturn = Quinta::Translate('Delivery Address:') . "\n\n";
		...
		*/
		...
		{
			$strToReturn = Quinta::Translate('Billing Address:') . "\n\n";
