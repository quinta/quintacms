	<div class="PrintAction button">
		<a href="javascript:window.print()">
			<?php print Quinta::Translate('Print'); ?>
		</a>
	</div>
	...
	<?php  print '<div class="heading">' . Quinta::Translate('Order Summary') . ':</div>'; ?>
...
<!--    the extra div is to fix a QCodo quirk ..              -->
			...
			<tbody>
				<?php
					//a quickie fake datagrid list .. Note: the CheckOutItemControllers are in <TD>s
