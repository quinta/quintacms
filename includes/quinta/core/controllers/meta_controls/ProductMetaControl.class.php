<?php
	require(__DATAGEN_META_CONTROLS__ . '/ProductMetaControlGen.class.php');

	/**
	 * This is a MetaControl customizable subclass, providing a QForm or QPanel access to event handlers
	 * and QControls to perform the Create, Edit, and Delete functionality of the
	 * Product class.  This code-generated class extends from
	 * the generated MetaControl class, which contains all the basic elements to help a QPanel or QForm
	 * display an HTML form that can manipulate a single Product object.
	 *
	 ...
	 */
	class ProductMetaControl extends ProductMetaControlGen
	{
		...
		{
			return $this->lblTypeId_Create($strControlId);
		}
	}
?>