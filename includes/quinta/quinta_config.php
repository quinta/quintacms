...
///Relative location of the Quinta tree..
...
if(!defined('__WWWROOT__') || !defined('__QUINTA_SUBDIRECTORY__')){
    ...
    */
    ...
    /// - see below.
    define('__QUINTA_ROOT__', __WWWROOT__ . __QUINTA_SUBDIRECTORY__ . __QUINTA_INCLUDES__ );
    ///Quinta core absolute directories
    define('__QUINTA_CORE__', __QUINTA_ROOT__ . '/core');
    ...
    define('__QUINTA_CONTRIB__', __QUINTA_ROOT__ . '/contrib');
    ...
    define('__QUINTA_LOCAL__', __QUINTA_ROOT__ . '/local');
    ...
    */
    ...
    define('__QCODO_ROOT__', __WWWROOT__ . __QUINTA_SUBDIRECTORY__ . '/..' );
