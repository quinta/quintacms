...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of AuthorizeNetTransaction objects
			return AuthorizeNetTransaction::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::AuthorizeNetTransaction()->Param1, $strParam1),
					QQ::GreaterThan(QQN::AuthorizeNetTransaction()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single AuthorizeNetTransaction object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of AuthorizeNetTransaction objects
			return AuthorizeNetTransaction::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::AuthorizeNetTransaction()->Param1, $strParam1),
					QQ::Equal(QQN::AuthorizeNetTransaction()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			$strQuery = sprintf('
				...
				FROM
					`authorize_net_transaction` AS `authorize_net_transaction`
				WHERE
					param_1 = %s AND
					param_2 < %s',
				$strParam1, $intParam2);
