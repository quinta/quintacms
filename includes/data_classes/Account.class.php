...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of Account objects
			return Account::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Account()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Account()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single Account object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Account objects
			return Account::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Account()->Param1, $strParam1),
					QQ::Equal(QQN::Account()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
